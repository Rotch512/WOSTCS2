...
class Settings:
    ...
    @property
    def player_summary_path(self) -> Path:
        return self.output_dir / "player_summary.json"

    @property
    def player_matches_path(self) -> Path:
        return self.output_dir / "player_matches.json"
    ...
    @property
    def match_stats_dir(self) -> Path:
        return self.output_dir / "matches"

    @property
    def match_details_dir(self) -> Path:
        return self.output_dir / "match_details"
